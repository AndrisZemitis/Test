...
$arr_transl[1]['num'] = "Nr.";
$arr_transl[1]['sia_vmf_latvia_valdes_loceklis'] = "SIA VMF LATVIA valdes loceklis _________________________________________ /Jānis Buļs/";
...
$arr_transl[2]['num'] = "No.";
$arr_transl[2]['sia_vmf_latvia_valdes_loceklis'] = "SIA VMF LATVIA member of board ______________________________________________ /Jānis Buļs/";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=653 style='border-collapse:collapse;table-layout:fixed;width:463pt'>
 ...
 <tr height=18 style='mso-height-source:userset;height:13.5pt'>
  ...
  <td colspan=3 class=xl71 style='border-right:1.0pt solid black;border-left:
  none'><?=substr($m['nr'],2,2)?>/<?=substr($m['nr'],4,2)?>/2012</td>
  <td colspan=6 style='mso-ignore:colspan'></td>
 </tr>
 ...
 <tr height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  <? if($metode_tmp == 1){ ?>
    <td class=xl31 x:num x:fmla="=ROUND(A14*B14*C14*E14%%%%,2)"><!--#kbrut#--></td>
  <? }else{ ?>
    <td class=xl31 x:num x:fmla="=ROUND(A14*B14*C14*E14%%%%,3)"><!--#kbrut#--></td>
  <? } ?>
  <td class=xl31 x:num><?=$bk?></td>
  <td class=xl31 x:num><?=$bp?></td>
  <? if($metode_tmp == 1){ ?>
    <td class=xl33 x:num x:fmla="=ROUND(F14-(F14*H14%),2)"><!--#knet#--></td>
  <? }else{ ?>
    <td class=xl33 x:num x:fmla="=ROUND(F14-(F14*H14%),3)"><!--#knet#--></td>
  <? } ?>
 ...
 <tr height=18 style='mso-height-source:userset;height:13.5pt'>
  ...
  <? if($metode_tmp == 1){ ?>
    <td class=xl448 x:num><?=number_format(round($pa_klasem_kopa_t0,2),2,'.','')?></td>
  <? }else{ ?>
    <td class=xl448 x:num><?=number_format($pa_klasem_kopa_t0,3,'.','')?></td>
  <? } ?>
  <td class=xl31 x:num><?=$liel_b_kods?></td>
  <td class=xl31 x:num><?=number_format(($pa_b_kodiem_kopa_t0/$pa_klasem_kopa_t0)*100,1,'.','')?></td>
  <? if($metode_tmp == 1){ ?>
    <td class=xl448 x:num><?=number_format(round($pa_sugam_kopa_t0,2),2,'.','')?></td>
  <? }else{?>
    <td class=xl448 x:num><?=number_format($pa_sugam_kopa_t0,3,'.','')?></td>
  <? } ?>
 ...
 <tr height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  <? if($metode_tmp == 1){ ?>
    <td colspan=3 class=xl449 style='border-right:1.0pt solid black;border-left:none' x:num><?=number_format(round($pa_klasem_kopa_t0,2),2,'.','')?></td>
  <? }else{ ?>
    <td colspan=3 class=xl59 style='border-right:1.0pt solid black;border-left:none' x:num><?=number_format($pa_klasem_kopa_t0,3,'.','')?></td>
  <? } ?>
  <td></td>
 ...
 <tr height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  <? if($metode_tmp == 1){ ?>
    <td colspan=3 class=xl450 style='border-right:1.0pt solid black;border-left:none' x:num x:fmla="=ROUND(F16*H16%,2)"><!--#brakis#--></td>
  <? }else{ ?>
    <td colspan=3 class=xl64 style='border-right:1.0pt solid black;border-left:none' x:num><?=number_format($pa_b_kodiem_kopa_t0,3,'.','')?></td>
  <? } ?>
  <td></td>
 ...
 <tr height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  <? if($metode_tmp == 1){ ?>
    <td colspan=3 class=xl450 style='border-right:1.0pt solid black;border-left:none' x:num><?=number_format(round($pa_sugam_kopa_t0,2),2,'.','')?></td>
  <? }else{ ?>
    <td colspan=3 class=xl64 style='border-right:1.0pt solid black;border-left:none' x:num><?=number_format($pa_sugam_kopa_t0,3,'.','')?></td>
  <? } ?>
  <td></td>
 ...
 <tr height=18 style='mso-height-source:userset;height:13.5pt'>
  ...
  none' x:num><? if ($_POST['metode_id'] == 1) {echo "LVS 82:2003 (1.3)";} else {echo "VMR 1-06 (4.3)";} ?></td>
  <td></td>
