...
?>
<center>
<form name=forma method=POST action="report_view_short.php?veids=<?=$veids?>&h=<?=$h?>" target=_blank>
...
<tr>
	<td align=right>Virsmērs:</td>
	<td align=left><input type=text name="min_virsmers<?=$grup?>" size=20 value="<?  if($tpl){echo $tpl['min_virsmers'.$grup];}else{echo $_POST['virsmers'.$grup];}?>"></td>
</tr>
